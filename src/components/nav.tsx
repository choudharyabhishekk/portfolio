        ...
        >
          ...
          >
            ...
            <ul
              ...
              className="flex flex-col md:flex-row list-none items-center border border-neutral-800 px-5 py-2 rounded-2xl md:space-x-1 gap-4 md:gap-4 w-full md:w-auto"
            >
